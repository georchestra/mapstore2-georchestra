/*
NOTE: This file is to be used to populate the "geostore" schema

For example in Windows:

To populate the "geostore" schema with the "georchestra" user:

psql -U georchestra -d georchestra -f 002_create_schema_postgres.sql
*/
    ...
    INSERT into geostore.gs_category (id ,name) values (7,  'GEOSTORY');
    INSERT into geostore.gs_category (id ,name) values (8,  'CONTEXT');
